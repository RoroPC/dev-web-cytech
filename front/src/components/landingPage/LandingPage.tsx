    ...
    return(
        <main>
            ...
            <article>
                ...
                <p>Que ce soit pour un anniversaire, un mariage, une naissance ou simplement pour exprimer votre amour,
                    nos collections de fleurs sont conçues pour capturer l'essence de chaque moment spécial.
                </p>
                <h3>Fleurs fraîches de qualité</h3>
                <p>
                    Nous nous engageons à vous offrir des fleurs fraîches et de la plus haute qualité. Chaque bouquet
                    est préparé avec soin par nos experts floraux pour garantir une expérience florale exceptionnelle.
                </p>
            </article>
            <article>
